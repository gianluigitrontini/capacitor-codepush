...
enum { STORE_VERSION = 0, UPDATE_CONFIRMED = 1, UPDATE_ROLLED_BACK = 2 };
...
- (id)initWithStatus:(ReportingStatus)status
...
- (id)initWithStatus:(ReportingStatus)status
                      ...
                      andAppVersion:(NSString *)appVersion
                   andDeploymentKey:(NSString *)deploymentKey
    andLastVersionLabelOrAppVersion:(NSString *)lastVersionLabelOrAppVersion
        andLastVersionDeploymentKey:(NSString *)lastVersionDeploymentKey;
